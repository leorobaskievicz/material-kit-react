...
import {
  ...
  FormControl,
  InputLabel,
  MenuItem, Alert, AlertTitle, FormHelperText,
  CardActionArea,
  CardActions,
  CardMedia
    ...
    isLoadingPromocao === true ? (
      ...
      <Formik
        initialValues={{
          ...
          dataini: !promocao ? moment().format('YYYY-MM-DD') : moment(promocao.data_inicio).format('YYYY-MM-DD'),
          datafim: !promocao ? moment().format('YYYY-MM-DD') : moment(promocao.data_final).format('YYYY-MM-DD'),
          banner1: '',
