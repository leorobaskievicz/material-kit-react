...
import * as YupVoucherEdit from 'yup';
...
const VoucherEdit = (props) => {
  ...
  return isLoadingVoucher === true ? (
    ...
    <Formik
      initialValues={{
        titulo: !voucher ? '' : voucher.titulo,
        texto: !voucher ? '' : voucher.texto,
        dataini: !voucher
          ? moment().format('YYYY-MM-DD')
          : moment(voucher.data_inicio).format('YYYY-MM-DD'),
        datafim: !voucher
          ? moment().format('YYYY-MM-DD')
          : moment(voucher.data_final).format('YYYY-MM-DD'),
        banner1: '',
        banner1Bd: !voucher ? null : voucher.banner1,
        voucher: '',
        voucherBd: !voucher ? null : voucher.voucher,
        status: !voucher ? '' : voucher.status
      }}
      validationSchema={YupVoucherEdit.object().shape({
        titulo: YupVoucherEdit.string().max(100).required('Título é obrigatório'),
        texto: YupVoucherEdit.mixed().required(
          'Texto descritivo da promoção é obrigatório'
        ),
        voucher: YupVoucherEdit.mixed(),
        voucherBd: YupVoucherEdit.mixed(),
        banner1: YupVoucherEdit.mixed(),
        banner1Bd: YupVoucherEdit.mixed(),
        dataini: YupVoucherEdit.date()
          .required('Data de início é obrigatório')
          .min(moment().format('YYYY-MM-DD'), 'Data de inicio inválida'),
        datafim: YupVoucherEdit.date()
